					...
					<div class="card">
						<div class="bg-soft-primary">
							<div class="row">
								...
								<div class="align-self-end col-5"><img src="assets/img/profile-img.png" alt=""
										class="img-fluid"></div>
							</div>
						</div>
						<div class="pt-0 card-body">
							<div class="row">
								<div class="col-sm-4">
									<div class="avatar-md profile-user mb-4"><img
											src="assets/img/profiles/avatar-05.jpg" alt=""
											class="img-thumbnail rounded-circle img-fluid"></div>
									<div class="d-block">
								...
								<div class="col-sm-8">
									<div class="pt-4">
										...
										<div class="mt-4"><a class="btn btn-primary waves-effect waves-light btn-sm"
												href="profile.php">View Profile <i
						...
						<div class="card-header">
							<div class="d-flex justify-content-between align-items-center">
								...
								<div class="dropdown" data-toggle="dropdown">
									<a href="javascript:void(0);" class="btn btn-white btn-sm dropdown-toggle"
									...
									<div class="col-4">
										<div class="mt-4">
											<p class="mb-2 text-truncate"><i
													class="fas fa-circle text-primary mr-1"></i> Invoiced</p>
											<h5>$ 2,132</h5>
										</div>
									</div>
									<div class="col-4">
										<div class="mt-4">
											<p class="mb-2 text-truncate"><i
													class="fas fa-circle text-success mr-1"></i> Received</p>
											<h5>$ 1,763</h5>
										</div>
									</div>
									<div class="col-4">
										<div class="mt-4">
											<p class="mb-2 text-truncate"><i
													class="fas fa-circle text-danger mr-1"></i> Pending</p>
											<h5>$ 973</h5>
										</div>
									</div>
								</div>
											...
											<td>
												<h2 class="table-avatar">
													<a href="profile.php" class="avatar avatar-sm mr-2"><img
															...
															alt="User Image"></a>
													<a href="profile.php">Jessica Fogarty</a>
												</h2>
											</td>
											...
											<td>
												<h2 class="table-avatar">
													<a href="profile.php" class="avatar avatar-sm mr-2"><img
															...
															alt="User Image"></a>
													<a href="profile.php">Jose Anderson</a>
												</h2>
											</td>
											<td>Algebra</td>
											<td>$4000.00</td>
